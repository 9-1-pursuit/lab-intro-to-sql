...
('warm vinalla candle', 'Ace', '15', FALSE),
('skateboard', 'Jamie', '140', TRUE),
('dirt bike', 'Lynn', '200', FALSE),
('gaming desktop', 'Aiden','1500', FALSE),
('digital camera', 'Sonny', '300', FALSE),
('electric guitar', 'Benji', '200', TRUE);

...
CREATE TABLE gifts (id serial, gift TEXT, giver VARCHAR(30), price INT, previously_regifted BOOL);
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('nintendo switch', 'Monica', 10, FALSE),
('iphone 14', 'Juan', 1000, TRUE),
('mustang', 'Krystal', 13, FALSE),
('yankee candle', 'John', 45, FALSE),
('rolex', 'Edgar', 200, TRUE)
;

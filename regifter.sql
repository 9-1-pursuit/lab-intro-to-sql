...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('pumpkin candle', 'Santa', '29', TRUE),
('toy box', 'Nick', '99', TRUE),
('diamonds', 'Rudolf', '42', FALSE),
('toy car', 'Elf on the Shelf', '5', TRUE),
('train set', 'The Boss', '4', FALSE)
;

...
CREATE TABLE gifts (id serial primary KEY, gift TEXT, giver VARCHAR(40), value INT, previously_regifted BOOLEAN);
-- 
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('Rose candle', 'Shemar', '90', FALSE),
('Bomber Jacket', 'April', '130', TRUE),
('PS5', 'Ant', '500', FALSE),
('Gym membership', 'Rok', '80', TRUE),
('Trip to Hawaii', 'Dev', '2000', FALSE)
;
...
--
SELECT * FROM gifts ORDER BY value DESC LIMIT 3 OFFSET 1;
--
-- finish
--

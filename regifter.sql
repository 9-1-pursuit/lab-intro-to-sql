...
CREATE TABLE gifts (id serial, gift TEXT, giver VARCHAR(30), value int, previously_regifted boolean);
-- 
...
--
INSERT INTO gifts (gift, giver, price, previously_regifted) VALUES ('toy house', 'Dorian', '20', FALSE),
('iPad', 'Girlfriend', '400', FALSE),
('flowers', 'mom', '12', TRUE),
('sneakers', 'Betty', '80', TRUE),
('lotion', 'Fahmee', '50', TRUE);

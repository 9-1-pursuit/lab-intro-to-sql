...
('stuffed teddy bear', 'Marry', '10', FALSE),
('wallet', 'Pops', '35', FALSE),
('speakers', 'Jay', '120', TRUE),
('DSLR camera', 'Luz', '1150', FALSE),
('phone case', 'Yisy', '12', FALSE);
...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('necklace', 'Tia', '25', FALSE),
('colorful candle', 'Bestie', '10', FALSE),
('shoes','Sammie Boy', '65', FALSE),
('cooking pots', 'Abuela', '200', TRUE),
('wine', 'Moe J', '20', FALSE);

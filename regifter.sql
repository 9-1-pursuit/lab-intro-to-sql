...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('red candle', 'no-one', '10', FALSE),
('antique plate from brazil', 'Jose', '1943', TRUE),
('soap on a dish', 'Patrick', '3', FALSE),
('vivarium', 'plant guy', '10000', TRUE),
('mango', 'The Vice Boss', '1000', FALSE)
;
